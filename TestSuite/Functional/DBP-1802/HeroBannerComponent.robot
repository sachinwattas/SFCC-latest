...
*** Test Cases ***
Banner Component Alt and Title for Digital Literacy
    [Documentation]  Business Manager displays Image Alt and Title attributes for Digital Literacy
    [Tags]  Scenario_DBP-2157 UserStory_DBP-1857
    When the images in Banner Component displays for Digital Literacy
    Then it shows images to have alt and title attributes for Digital Literacy
